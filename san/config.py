...
def add_san_config(cfg):
    ...
    cfg.MODEL.SAN.VQ_WEIGHT = 0.0
    cfg.MODEL.SAN.PERCEPT_WEIGHT = [0.5, 1.0, 2.0]
    cfg.MODEL.SAN.CLASS_WEIGHT = 2.0
    cfg.MODEL.SAN.DICE_WEIGHT = 5.0
    cfg.MODEL.SAN.MASK_WEIGHT = 5.0
    # cfg.MODEL.SAN.CLASS_WEIGHT = 0.02
    # cfg.MODEL.SAN.DICE_WEIGHT = 0.05
    # cfg.MODEL.SAN.MASK_WEIGHT = 0.05
    ...
    cfg.MODEL.SAN.SLS_TOKEN_FORMAT = "query_token"
    ...
    cfg.MODEL.SIDE_ADAPTER.DEEP_SUPERVISION_IDXS = [8]
